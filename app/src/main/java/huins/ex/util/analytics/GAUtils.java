package huins.ex.util.analytics;
...
public class GAUtils {
	...
	public static void initGATracker(GCSBaseApp app) {
		if (sAppTracker == null) {
			...
			analytics.setAppOptOut(!new GCSPreferences(context).isUsageStatisticsEnabled());
	...
	public static void startNewSession(Context context) {
		final GCSPreferences prefs = new GCSPreferences(context);
