...
public class NotificationHandler {
    ...
    //private final TTSNotificationProvider mTtsNotification;-----mhmd

    /**
     * Handles Droidplanner's status bar notification.
     */
    //private final StatusBarNotificationProvider mStatusBarNotification;----mhmd
   ...
   //     mStatusBarNotification = new StatusBarNotificationProvider(context, flight);
    ...
    public void terminate() {
       ...
       // mTtsNotification.onTerminate();           ======= mhmd
