...
import static huins.ex.core.ErrorType.ALTITUDE_DISPARITY;
import static huins.ex.core.ErrorType.ARM_COMPASS_CALIBRATION_RUNNING;
import static huins.ex.core.ErrorType.ARM_GYRO_CALIBRATION_FAILED;
import static huins.ex.core.ErrorType.ARM_LEANING;
import static huins.ex.core.ErrorType.ARM_MODE_NOT_ARMABLE;
import static huins.ex.core.ErrorType.ARM_ROTOR_NOT_SPINNING;
import static huins.ex.core.ErrorType.ARM_SAFETY_SWITCH;
import static huins.ex.core.ErrorType.ARM_THROTTLE_BELOW_FAILSAFE;
import static huins.ex.core.ErrorType.ARM_THROTTLE_TOO_HIGH;
import static huins.ex.core.ErrorType.AUTO_TUNE_FAILED;
import static huins.ex.core.ErrorType.CRASH_DISARMING;
import static huins.ex.core.ErrorType.EKF_VARIANCE;
import static huins.ex.core.ErrorType.LOW_BATTERY;
import static huins.ex.core.ErrorType.NO_DATAFLASH_INSERTED;
import static huins.ex.core.ErrorType.NO_ERROR;
import static huins.ex.core.ErrorType.PARACHUTE_TOO_LOW;
import static huins.ex.core.ErrorType.PRE_ARM_ACCELEROMETERS_NOT_HEALTHY;
import static huins.ex.core.ErrorType.PRE_ARM_ACRO_BAL_ROLL_PITCH;
import static huins.ex.core.ErrorType.PRE_ARM_BAROMETER_NOT_HEALTHY;
import static huins.ex.core.ErrorType.PRE_ARM_CHECK_ANGLE_MAX;
import static huins.ex.core.ErrorType.PRE_ARM_CHECK_BOARD_VOLTAGE;
import static huins.ex.core.ErrorType.PRE_ARM_CHECK_FAILSAFE_THRESHOLD_VALUE;
import static huins.ex.core.ErrorType.PRE_ARM_CHECK_FENCE;
import static huins.ex.core.ErrorType.PRE_ARM_CHECK_MAGNETIC_FIELD;
import static huins.ex.core.ErrorType.PRE_ARM_COMPASS_NOT_CALIBRATED;
import static huins.ex.core.ErrorType.PRE_ARM_COMPASS_NOT_HEALTHY;
import static huins.ex.core.ErrorType.PRE_ARM_COMPASS_OFFSETS_TOO_HIGH;
import static huins.ex.core.ErrorType.PRE_ARM_DUPLICATE_AUX_SWITCH_OPTIONS;
import static huins.ex.core.ErrorType.PRE_ARM_EKF_HOME_VARIANCE;
import static huins.ex.core.ErrorType.PRE_ARM_GPS_GLITCH;
import static huins.ex.core.ErrorType.PRE_ARM_GYROS_NOT_HEALTHY;
import static huins.ex.core.ErrorType.PRE_ARM_HIGH_GPS_HDOP;
import static huins.ex.core.ErrorType.PRE_ARM_INCONSISTENT_ACCELEROMETERS;
import static huins.ex.core.ErrorType.PRE_ARM_INCONSISTENT_COMPASSES;
import static huins.ex.core.ErrorType.PRE_ARM_INCONSISTENT_GYROS;
import static huins.ex.core.ErrorType.PRE_ARM_INS_NOT_CALIBRATED;
import static huins.ex.core.ErrorType.PRE_ARM_NEED_GPS_LOCK;
import static huins.ex.core.ErrorType.PRE_ARM_RC_NOT_CALIBRATED;
import static huins.ex.core.ErrorType.RC_FAILSAFE;
import static huins.ex.core.ErrorType.WAITING_FOR_NAVIGATION_ALIGNMENT;
...
public class AndroidApWarningParser implements AutopilotWarningParser {
     ...
     */
    @Override
    public String parseWarning(Flight flight, String warning) {
