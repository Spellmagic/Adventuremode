...
public class msg_limits_status extends MAVLinkMessage{
    ...
    */
    public void unpack(MAVLinkPayload payload) {
        ...
        this.last_trigger = payload.getInt();
        	    
        this.last_action = payload.getInt();
        	    
        this.last_recovery = payload.getInt();
        	    
        this.last_clear = payload.getInt();
        	    
        this.breach_count = payload.getShort();
        	    
        this.limits_state = payload.getByte();
        	    
        this.mods_enabled = payload.getByte();
        	    
        this.mods_required = payload.getByte();
        	    
        this.mods_triggered = payload.getByte();
