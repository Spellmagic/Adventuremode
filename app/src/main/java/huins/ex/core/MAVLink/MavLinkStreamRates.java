...
import huins.ex.com.MAVLink.common.msg_request_data_stream;
import huins.ex.com.MAVLink.enums.MAV_DATA_STREAM;

public class MavLinkStreamRates {

	public static void setupStreamRates(MAVLinkStreams.MAVLinkOutputStream
												MAVClient, byte sysid, byte compid,
	...
	private static void requestMavlinkDataStream(MAVLinkStreams.MAVLinkOutputStream mAVClient, byte sysid,
