 ...
 * Original file: C:\\Users\\KJH\\OneDrive\\GCST\\app\\src\\main\\aidl\\huins\\ex\\proto\\IObserver.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements huins.ex.proto.IObserver
{
private static final java.lang.String DESCRIPTOR = "huins.ex.proto.IObserver";
...
/**
 * Cast an IBinder object into an huins.ex.proto.IObserver interface,
 * generating a proxy if needed.
 */
public static huins.ex.proto.IObserver asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof huins.ex.proto.IObserver))) {
return ((huins.ex.proto.IObserver)iin);
}
return new huins.ex.proto.IObserver.Stub.Proxy(obj);
}
...
private static class Proxy implements huins.ex.proto.IObserver
{
